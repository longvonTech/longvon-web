...
@Module({
  ...
  providers: [
    GrowthRepository, QwenService, CrawlerService,
    IntelligenceService, KeywordService, ContentStrategyService,
    ContentFactoryService, ImagePromptService, PublishingService,
    SeoIntelligenceService, ExecutiveBriefService, SeoOptimizerService, HealthMonitorService,
  ],
  exports: [GrowthRepository, QwenService, ContentFactoryService, PublishingService, ExecutiveBriefService, SeoOptimizerService, HealthMonitorService],
})
